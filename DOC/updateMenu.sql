...
( 118,'舆情管理','',2,6,2,'images/contact_email.png'),
( 119,'基础配置','',3,6,2,'images/contact_email.png'),
( 120,'事件管理','',1,6,2,'images/contact_email.png'),
...
( 1040,'疫情定义库','EpidemicDom',1,120,3,'images/productCategory.gif'),
( 1041,'事件维护','EventDom',2,120,3,'images/productCategory.gif')
...
(1,106),(1,107),(1,108),(1,109),(1,110),(1,111),(1,112),(1,113),(1,114),(1,115),(1,116),(1,117),(1,118),(1,119),(1,120),
...
SELECT * FROM MENU WHERE MENU_ID = 1040
